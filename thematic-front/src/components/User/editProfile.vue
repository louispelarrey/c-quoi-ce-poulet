      ...
      <div class="w-full max-w-md">
        <div class="flex justify-between">
          <div class="pb-4">
            ...
            <input id="numberPhone" name="numberPhone" class="border rounded-r px-4 py-2 w-full"
        ...
        <div class="flex justify-between" v-if="adminEdit">
          <div class="pb-4">
            <label for="about" class="font-semibold text-gray-700 block pb-1">Roles</label>
            <select v-model="user.roles[0]" id="countries"
